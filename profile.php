              ...
              <div class="col-sm-3 col-md-4">
                 <div class="panel panel-default">
                    <div class="panel-body"  >
                      ...
                      <h4 style="text-align:center"><?=$row['full_name']?><br><small>@<?=$row['college']?></small></h4>
                      <p>Branch: <small><?=$row['branch']?></small></p>
                      <p>Sem: <small><?=$row['sem']?></small></p>
                      <p>Email: <small><?=$row['email']?></small></p>
                      <form role="form" action="details.php" method="post" enctype="multipart/form-data">
                            <a type="submit" href="edit_profile" class="btn btn-success pull-left">Edit Profile</a>
              ...
              if ($data){
                while($f_data = mysqli_fetch_array($sql_recent_result, MYSQLI_ASSOC)){
                  ...
                  <div class="panel project-pack panel-default">
                   <div class="panel-body">
                     <h4><a href="details.php"><?php echo $f_data['project_title']; ?></a>
                      <small class="pull-right">End : <?php echo populate($f_data['end']); ?></small>

                       <small class="pull-right">Start : <?php echo $f_data['_begin']; ?> &nbsp;</small>
                     </h4>
